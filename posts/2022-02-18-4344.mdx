---
page_id: 38aa954b-2063-8193-810d-ca723771c5ac
title: BOJ - [Array - 4344 평균은 넘겠지] - Bronze I 🥉
slug: 2022-02-18-4344
featured: false
description: https://www.acmicpc.net/problem/4344 각 케이스별로 평균을 넘는 점수를 가진 사람이 몇 % 인지
  구하는 문제이므로 일단 for문으로 여러개의 케이스를 받을 수 있도록 하고 중첩으로 for문을 넣어 점수를 입력받는 동시에 score배열에 저장하고
  tota...
category: 백준
tags:
- 백준
...
- Array
date: '2022-02-18'
content_hash: 14ca460fe955d44e8a04c80a86076cb646120ebb333baf6a68bc24ca4b54b295
---
