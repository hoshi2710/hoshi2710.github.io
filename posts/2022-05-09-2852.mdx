...
description: "https://www.acmicpc.net/problem/2852 역시 최근들어 온라인 저지의 문제들을 풀는것을 게을리 하였어서 그런지 이런 실버정도 난이도의 문제도 시간이 좀 시간이 걸릴정도록 실력이 많이 떨어진 것 같다. 조금더 분발 해야할 듯 하다. 😅"
date: "2022-05-09"
category: "백준"
