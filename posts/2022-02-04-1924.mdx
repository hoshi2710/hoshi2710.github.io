...
description: "https://www.acmicpc.net/problem/1924 2007 년 X월 Y일이 무슨요일인지 구하는 문제였다. 나는 monthfirstyoil 배열에 맨처음부터 1 월에서 12 월까지 그 달의 첫째날이 무슨요일인지 미리 집어넣어 두었다. (0 은 월요일 5 는 토요일 이..."
date: "2022-02-04"
category: "백준"
